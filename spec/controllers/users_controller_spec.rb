...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    it "should show the user's microposts" do
      mp1 = Factory(:micropost, :user => @user, :content => "Foor Bar")
  ...
  describe "POST 'create'" do
    ...
    describe "failure" do
      ...
      before(:each) do
        @attr = {:name => "", :email => "",
          :password => "", :password_conmfirmation => ""}
      end
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = {:name => "New User", :email => "user@example.com",
          :password => "foobar", :password_conmfirmation => "foobar"}
      end
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = {:name => "New Name", :email => "user@example.org",
          :password => "barbaz", :password_conmfirmation => "barbaz"}
      end
